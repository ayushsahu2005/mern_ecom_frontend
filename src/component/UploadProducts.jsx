...
const UploadProducts=()=>{
 ...
 const handleSubmit=async(e)=>{
  ...
  try {
    ...
    formData.append('upload_preset', 'ilijbaxw');
    formData.append('cloud_name', 'dmaqeziiy');
    const response = await axios.post(' https://api.cloudinary.com/v1_1/dmaqeziiy/image/upload', formData);
...
<div style={{width:"500px"}}>
  <form>
    ...
    <select id="country" name="subcategory" value={input.subcategory}    onChange={handleInput}  >
      ...
      <option value="Diver Watch">Diver Watch</option>
    </select>
